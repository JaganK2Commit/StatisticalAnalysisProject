...
The "cleaned" dataset now offers *12,475 observations* and *38 variables*.
...
We shall find the significant variables with alpha 0.05.
...
model_measures(list(housing_data_model, housing_data_model_significant), c("All predictors", "Significant predictors"))
...
We'll also try to lower the value of LOOCV_RMSE (< 110989) to explain the data.
...
model_measures(list(housing_data_model, housing_data_model_aic, housing_data_model_bic), c("Additive model", "AIC model", "BIC model"))
