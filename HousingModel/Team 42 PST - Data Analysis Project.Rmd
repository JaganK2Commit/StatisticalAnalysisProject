...
selected_housing_data = subset(raw_housing_data, select = -c(zpid, latest_saledate,latest_salemonth, latestPriceSource,city, homeImage, streetAddress, numOfPhotos))
