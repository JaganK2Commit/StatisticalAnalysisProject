...
From the $R^2$ value, about `r summary(housing_data_model_interaction)$r.squared` of data is explained by this model, with `r length(coef(housing_data_model_interaction))` predictors. The adjusted $R^2$  is `summary(housing_data_model_interaction)$adj.r.squared `. This model is preferred over the additive model. 
